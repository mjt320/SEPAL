...
class calculator(ABC):
    ...
    def proc_image(self, input_images, arg_images=None, mask=None, threshold=-np.inf, write_output=True, prefix="", suffix="", filters=None, template=None):
        ...
        # Process first voxel to get output sizes
        # Prepare dict of pre-allocated output arrays
        outputs = {}
        out = self.proc(data_2d[0], *args_1d[0])           
